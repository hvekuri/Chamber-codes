...
metadata_path = "Chamber-codes/JF_example_files/JF_metadata.csv"

# Folder(s) where licor and rpi files are
folder_licor = "Chamber-codes/JF_example_files/Data/"
folder_rpi = "Chamber-codes/JF_example_files/Data/"

# Constants for fixing gas analyzer drift
drift_path = "Chamber-codes/JF_example_files/DriftFix.xlsx"
